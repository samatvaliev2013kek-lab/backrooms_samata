...
@export var move_distance : float = 4.0  # На сколько метров вниз уедет дверь
@export var move_duration : float = 7.0  # Длительность анимации в секундах
...
func _open_door():
	var target_position = door.position + Vector3.DOWN * move_distance
